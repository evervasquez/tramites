...
public class UITableView extends LinearLayout {
	...
	//***para mostrar datos horizontales
	public void addBasicItem(String title, String summary1, String summary2,
			String summary3) {
		mItemList.add(new BasicItem(title, summary1, summary2, summary3));
	}
	
	// sin imagen
	public void addBasicItem(String title, String summary1, String summary2,
			String summary3, String summary4) {
		mItemList.add(new BasicItem(title, summary1, summary2, summary3,
				summary4));
	}

	// con imagen
	public void addBasicItem(int drawable, String title, String summary1,
			String summary2, String summary3, String summary4) {
		mItemList.add(new BasicItem(drawable, title, summary1, summary2,
				summary3, summary4));
	}

	// con imagen y color
	public void addBasicItem(int drawable, String title, String summary1,
			String summary2, String summary3, String summary4, int color) {
		mItemList.add(new BasicItem(drawable, title, summary1, summary2,
				summary3, summary4, color));
	}

	// sin imagen y color
	public void addBasicItem(String title, String summary1, String summary2,
			String summary3, String summary4, int color) {
		mItemList.add(new BasicItem(title, summary1, summary2, summary3,
				summary4, color));
	}
	...
	//************************ mio
	public void commitEver(){
		for (IListItem obj : mItemList) {
		View tempItemView = mInflater.inflate(R.layout.custom_ever,
				null);
	...
	public void commit() {
		mIndexController = 0;
		// ******cambie por = para que arme tambien el 1
		if (mItemList.size() > 1) {
	...
	private void setupBasicItem(View view, BasicItem item, int index) {
		...
		if (item.getSubtitle1() != null) {
				((TextView) view.findViewById(R.id.subtitle1))
						.setText(item.getSubtitle1());
		...
		/****************************************************************************/
		if (item.getSubtitle2() != null) {
			((TextView) view.findViewById(R.id.subtitle2)).setText(item
					.getSubtitle2());
		} else {
			((TextView) view.findViewById(R.id.subtitle2))
				.setVisibility(View.GONE);
		}
		if (item.getSubtitle3() != null) {
			((TextView) view.findViewById(R.id.subtitle3)).setText(item
					.getSubtitle3());
		} else {
			((TextView) view.findViewById(R.id.subtitle3))
					.setVisibility(View.GONE);
		}
		if (item.getSubtitle4() != null) {
			((TextView) view.findViewById(R.id.subtitle4)).setText(item
					.getSubtitle4());
		} else {
			((TextView) view.findViewById(R.id.subtitle4))
					.setVisibility(View.GONE);
		}
		/*******************************************************************************/
		((TextView) view.findViewById(R.id.titleui)).setText(item.getTitle());
		if (item.getColor() > -1) {
			((TextView) view.findViewById(R.id.titleui)).setTextColor(item
					.getColor());
		}
		view.setTag(index);
		if (item.isClickable()) {
